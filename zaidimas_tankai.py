...
def position():
    for pozicija in gridas:
        if pozicija == "→" or pozicija == "←" or pozicija == "↓" or pozicija == "↑":
            position = gridas.index(pozicija)
            return position
...
class Tankas:
    ...
    def virsun(self):
        ...
        # for nr, element in enumerate(gridas):
        #     print(gridas.index(element))
        #     if gridas[9:64]:
        #         if gridas[element] != "_" and gridas[element] != "T":
        #             gridas[nr] = "↑"
        #             gridas[element] = "_"
    ...
    def zemyn(self):
        ...
        # if gridas[1] != "_" and gridas[1] != "T":s
